...
export const HomeChip = () => {
  return (
    <section className="mx-auto w-full  px-6 py-12 sm:px-10">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {chips.map((chip) => (
          <button
            ...
            style={{
              backgroundImage: `linear-gradient(to right, ${chip.lightColor}, #FFFFFF)`,
            }}
          >
            <div
            ...
            <div style={{ background: chip.lightColor }} className="flex h-12 w-12 shrink-0 rounded-full items-center justify-center  transition-transform duration-200 group-hover:translate-x-1">
